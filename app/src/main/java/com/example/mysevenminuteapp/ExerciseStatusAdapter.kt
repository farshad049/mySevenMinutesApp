...
import com.example.mysevenminuteapp.databinding.ItemExerciseStatusBinding
        ...
        when{
            model.getIsSelected()->{
                holder.tvItem.background=
                    ContextCompat.getDrawable(holder.itemView.context,R.drawable.item_circular_color_white_background)
